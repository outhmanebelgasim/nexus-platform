    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/sensors/**", "/api/measurements/**", "/api/alerts/**", "/api/import-logs/**")
                        .hasAnyRole("SUPER_ADMIN", "ADMIN", "TECHNICIAN", "VIEWER")
                        .requestMatchers("/api/sensors/**", "/api/measurements/**", "/api/alerts/**", "/api/import-logs/**")
